...
if __name__ == "__main__":
    ...
    # ------------------------------------------------------------------ #
    #  Novelty flags: Hybrid AO+DRL, PER, and Discrete Phase Shifts       #
    # ------------------------------------------------------------------ #
    parser.add_argument("--use_ao", default=True, type=lambda x: x.lower() != 'false',
                        help='Use Zero-Forcing Alternating Optimization for beamforming G (default: True)')
    parser.add_argument("--use_per", default=True, type=lambda x: x.lower() != 'false',
                        help='Use Prioritized Experience Replay buffer (default: True)')
    parser.add_argument("--use_discrete_phases", default=False, type=lambda x: x.lower() != 'false',
                        help='Restrict RIS phase shifts to discrete hardware levels (default: False)')
